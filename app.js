...
async function runChat(userInput) {
  ...
  // Memulai obrolan dengan model generatif
  ...
  // Mengirim pesan pengguna ke model generatif dan mendapatkan respons
...
// Memberikan gambar loader
app.get('/loader.gif', (req, res) => {
  res.sendFile(__dirname + '/loader.gif');
});

// Endpoint untuk menerima pesan dari pengguna dan memberikan respons
app.post('/chat', async (req, res) => {
  try {
    ...
    // Menjalankan obrolan dengan model generatif
